...
wp_enqueue_style('bootstrap-timepicker-style',get_template_directory_uri() . '/css/bootstrap-timepicker.min.css' );  
	...
	wp_localize_script( 'ajax_urls', 'cs_user', array( 'url' => site_url('/wp-json/users/') ));
	wp_localize_script( 'ajax_urls', 'cs_jobs', array( 'url' => site_url( '/wp-json/jobs/' ) ));
...
require get_parent_theme_file_path( '/inc/class-WPmodify.php' );
require get_parent_theme_file_path( '/inc/validator.php' );
require get_parent_theme_file_path( '/inc/class-job_handler.php' );
...
function custom_user_role() {
       add_role( 'provider', 'Service Provider', array( 'read' => true, 'level_0' => true ) );
       add_role( 'customer', 'Customer', array( 'read' => true, 'level_0' => true ) );
   }

add_action('after_setup_theme', 'custom_user_role');
/**
 * Custom Class Service provider
 */
